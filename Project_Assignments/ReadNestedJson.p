...
DEFINE TEMP-TABLE tt-customer NO-UNDO SERIALIZE-NAME "Customer" 
...
DEFINE TEMP-TABLE tt-order NO-UNDO SERIALIZE-NAME "Order"
...
ASSIGN 
    cDir       = SESSION:TEMP-DIRECTORY
    cInputfile = cDir + "NestedJson.json".
...
FOR EACH tt-customer NO-LOCK:
    DISP tt-customer WITH 1 COL.    
END.
    
hDataset:WRITE-JSON("file", "C:\OpenEdge\NestedJsonop.json",TRUE,?,TRUE,TRUE).  
