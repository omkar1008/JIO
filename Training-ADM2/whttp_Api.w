...
DEFINE FRAME DEFAULT-FRAME
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 159.2 BY 22.48 WIDGET-ID 100.
...
DEFINE VARIABLE oOrders         AS JsonObject      NO-UNDO.
...
oURI = NEW URI('http', '192.168.29.107', 8810).

oURI:Path =  '/MyFirstApiProject/rest/MyFirstApiProjectService/CustomerOperation?iCustNum=' + fiCustNum:SCREEN-VALUE.
...
MESSAGE string (oJsonResponse:GetJsonText())
VIEW-AS ALERT-BOX.

oCustomer = oJsonResponse:GetJsonObject("CustomerInfo"). 
//oCustomer = oJsonResponse. 
...
DO:
    ASSIGN 
        fiCustNum:SCREEN-VALUE = STRING(ttCustomer.Cust-Num)
...
END.
 ...
 oOrders = oJsonResponse:GetJsonObject("Orders").  
